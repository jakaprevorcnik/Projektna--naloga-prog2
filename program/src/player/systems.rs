...
fn check_collsion_meteor_player_rough_aux(
    met_x0: f32,
    met_y0: f32,
    met_radij: f32,
    levi_rob: f32,
...
if let Ok((player_entity, player_transform)) = player_query.get_single_mut() {
        ...
        for (meteor_tranform, meteor) in meteor_query.iter_mut() {
            ...
            if check_collsion_meteor_player_rough_aux(met_x0, met_y0, meteor.radij, levi_rob, desni_rob, zgornji_rob, spodnji_rob) {
