...
use crate::player::{components::*, resources::BulletShootTimer};
...
pub const OGLISCA_LADJE_SLIKA: [Vec2; 10] = [Vec2::new(28., 0.), Vec2::new(72., 0.), Vec2::new(90., 18.), Vec2::new(100., 74.),
    Vec2::new(94., 81.), Vec2::new(90., 82.), Vec2::new(14., 82.), Vec2::new(6., 81.),
    Vec2::new(0., 74.), Vec2::new(10., 18.)];
pub const CENTER_LADJE_SLIKA: Vec2 = Vec2::new(50., 41.);
